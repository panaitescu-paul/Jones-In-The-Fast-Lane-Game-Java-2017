 ...
 */
public class LearnComputerScienceAction extends Action {
    // Game info
    private Player player;

    public LearnComputerScienceAction(Player player, int duration) {
        super(duration);
    ...
    public void consumeTick() {
        ...
        player.computerScienceKnowledge.increase(2);
